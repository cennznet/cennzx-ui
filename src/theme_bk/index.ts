...
// @ts-ignore
import defaultTheme, {colors as defaultColors, utils} from 'centrality-react-core/components/defaultTheme';
// @ts-ignore
import mediaQueries from 'centrality-react-core/components/defaultTheme/media';
import * as R from 'ramda';
import appComponentStyle from './appComponentStyle';
import * as appThemeColors from './appThemeColors';
...
const theme = R.mergeDeepRight(defaultTheme, customTheme) as any;
